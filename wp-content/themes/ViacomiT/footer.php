	...
	<footer id="colophon" class="site-footer" role="contentinfo">
    	<div class="grid grid-pad">
            ...
            <div class="col-footer-left">
            	<?php if ( get_theme_mod( 'blackandwhite_footer_name' ) ) : ?>
                	<h2><?php echo esc_html( get_theme_mod( 'blackandwhite_footer_name' )); // change the footer name ?></h2>
				<?php endif; ?>
        		<?php if ( get_theme_mod( 'blackandwhite_footer_slogan' ) ) : ?>
                	<p><?php echo esc_html( get_theme_mod( 'blackandwhite_footer_slogan' )); // change the footer slogan ?></p>
				<?php endif; ?>
    	...
    	<div class="grid grid-pad">
			...
			<?php if ( get_theme_mod( 'blackandwhite_footerid' ) ) : ?> 
        		<?php echo esc_html( get_theme_mod( 'blackandwhite_footerid' )); ?>  
			<?php else : ?>  
