...
'blackandwhite', //Theme slug. Usually the same as the name of its directory. 
'http://modernthemes.net/updates/?action=get_metadata&slug=blackandwhite' //Metadata URL. 
);
...
add_action( 'wp_enqueue_scripts', 'blackandwhite_enqueue_awesome' ); 

function blackandwhite_enqueue_awesome() {
wp_enqueue_style( 'blackandwhite-font-awesome', '//netdna.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css', array(), '4.5.0' );  
} 
