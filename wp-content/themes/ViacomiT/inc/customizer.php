...
function blackandwhite_theme_customizer( $wp_customize ) {
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'blackandwhite_link_color', array(
        'label'	   => __( 'Link and Highlight Color', 'blackandwhite' ),
        'section'  => 'colors',
    ...
    $wp_customize->add_section( 'blackandwhite_logo_section' , array(  
	    ...
	    'priority'    => 25,
	    'description' => __( 'Upload a logo to replace the default site name and description in the header. Also, upload your site favicon and Apple Icons.', 'blackandwhite' ), 
	) );
