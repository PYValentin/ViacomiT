         			...
         			<div class="slide-title-wrap">
                        <div class="grid">
         					<div class="slide-title-container col-5-12">
            					...
            					<a href="<?php the_permalink(); ?>" class="featured-link"><?php echo esc_html( get_theme_mod( 'blackandwhite_button_text' )); ?></a> 
		...
		<main id="main" class="site-main grid stories" role="main">
        	...
        	<div class="col-1-1">
        		<?php if ( get_theme_mod( 'blackandwhite_featured_title' ) ) : ?>
        			<h1 class="featured-title"><?php echo esc_html( get_theme_mod( 'blackandwhite_featured_title' )); // change the title ?></h1>
            	<?php endif; ?> 
        	</div><!-- col-1-1 -->
                	...
                	<div class="featured-info featured-container"> 
                    	...
                    	<a class="read-up" href="<?php the_permalink(); ?>">
                    		<?php if ( get_theme_mod( 'blackandwhite_button_text' ) ) : ?>
								<?php echo esc_html( get_theme_mod( 'blackandwhite_button_text' )); // change the text ?>
                    		<?php endif; ?>
                    	</a>   
                	</div><!-- featured-info --> 
		...
		<main id="main" class="site-main grid" role="main">
			...
			<?php if ( get_theme_mod( 'blackandwhite_editorial_title' ) ) : ?>
            	<h1 class="featured-black">    
					<?php echo esc_html( get_theme_mod( 'blackandwhite_editorial_title' )); // change the title ?>
            	</h1>  
            <?php endif; ?>
